...
//  FadeOutScene01 ================================
    ...
    $(".scene04").each(function () {
        const scene04In = TweenMax.fromTo($(this), 2, {opacity: 0}, {opacity: 1, ease: Power1.easeIn});

        let scene4Scene = new ScrollMagic.Scene({
            triggerElement: '.scene04',
            duration: 500,
            triggerHook: .6,
            offset: 0
        });
        scene4Scene.setTween(scene04In);
        scene4Scene.addTo(controller);
        //scene4Scene.addIndicators({name: "TEST", colorStart: "orange", colorEnd: "orange"});
    });
    //  END FadeInScene04 text ================================
    ...
    $(".scene04").each(function () {
        ...
        scene4Scene.setTween(scene04Out);
        scene4Scene.addTo(controller);
    });
    //  END FadeOutScene04 ================================
    ...
    //TEXT
    scene04Action.to('.scene04 #scene04_textblock1', 10, {autoAlpha: 1, y: 100}, "+=2");
    scene04Action.to('.scene04 #scene04_textblock1', 10, {autoAlpha: 0, y: -250}, "+=4");
    scene04Action.to('.scene04 #scene04_textblock2', 10, {autoAlpha: 1, y: 100}, "-=5");
    scene04Action.to('.scene04 #scene04_textblock2', 10, {autoAlpha: 0, y: -250}, "+=4");
    scene04Action.to('.scene04 #scene04_textline1', 10, {autoAlpha: 1, y: 210}, "+=2");
    scene04Action.to('.scene04 #scene04_textline1', 10, {autoAlpha: 0}, "+=4");
    //BLUR END
    scene04Action.to('.blur', 20, {webkitFilter: 'blur(0px)', filter: 'blur(0px)'}, "+=2");
    scene04Action.to('.scene04 #scene04_textblock3', 10, {autoAlpha: 1, y: 100}, "-=5");
    scene04Action.to('.scene04 #scene04_textblock3', 10, {autoAlpha: 0, y: -250}, "+=4");
    scene04Action.to('.scene04 #scene04_textline2', 10, {autoAlpha: 1, y: 210}, "+=2");
    scene04Action.to('.scene04 #scene04_textline2', 10, {autoAlpha: 0}, "+=4");
